...
const validUsername = new RegExp('^[a-zA-Z0-9]{3,40}$');

const validEmail = new RegExp('^[a-zA-Z0-9].{2,39}$');
const validPassword = new RegExp('^(?=.*[A-Z]).{0,40}$');
		...
		<div className="auths">
			<div className="authContainer">
				...
				<div className="errs">
					...
					{passErr && (
						<h5>
							Slaptažodis turi turėti nors vieną didžiają raidę ir turi būti ne ilgesnis nei 40 simbolių
						</h5>
					)}
					{usernameErr && (
						<h5>
							Vartotojo vardas turi būti nuo 3 iki 40 simbolių, gali susidaryti tik is raidžių ir skaičių
						</h5>
					)}
				...
				>
					<input type="text" name="username" id="regUsername" placeholder="Vartotojo vardas" required />
					<input type="email" name="email" placeholder="El. Paštas" id="regEmail" required />
